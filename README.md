...
<p align="center">
  <img src="https://github.com/lucasrsnd/lucasrsnd/blob/main/img/header.png?raw=true" width="100%"/>
</p>
...
**[Tô de Carro](https://github.com/lucasrsnd/to-de-carro)** → Desenvolvi um backend completo para aluguel de veículos, com: API RESTful para cadastro de clientes, pedidos e aprovação de contratos, validação financeira e armazenamento seguro em PostgreSQL, frontend demonstrativo em HTML/CSS/JS para interação com a API.  
**[Tech Frotas](https://github.com/lucasrsnd/ti-3-tech-frotas)** → Backend para gestão de frotas com cadastro de veículos, motoristas e controle financeiro, relatórios em PDF (economizando 10h/mês em processos manuais), desenvolvido em equipe com Scrum e versionamento no GitHub.  
**[Easy Donate](https://github.com/lucasrsnd/ti-2-easy-donate)** → Backend em Spring Boot para plataforma de doações, com API RESTful e MySQL, implementação de cadastro de usuários, instituições e processamento de transações, desenvolvimento colaborativo usando Git e Scrum.
...
- ☕ Sou entusiasta da linguagem java, veja alguns projetos que fiz <a href="https://github.com/lucasrsnd?tab=repositories" target="_blank">aqui</a>.<br />
...
<div>
<img alt="GIF" src="https://github.com/lucasrsnd/lucasrsnd/blob/main/img/dev.gif?raw=true" width="200px" height="200px" style="max-width: 100%; border-radius: 10px;"/>
</div>
</td>
</tr>
<tr>
