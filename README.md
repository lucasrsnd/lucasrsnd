...
**[TechFrotas](https://github.com/lucasrsnd/Projetos-Full-stack/tree/main/Projetos/TechFrotas)** → Backend para gestão de frotas com cadastro de veículos, motoristas e controle financeiro, relatórios em PDF (economizando 10h/mês em processos manuais), desenvolvido em equipe com Scrum e versionamento no GitHub.  
**[EasyDonate](https://github.com/lucasrsnd/Projetos-Full-stack/tree/main/Projetos/EasyDonate)** → Backend em Spring Boot para plataforma de doações, com API RESTful e MySQL, implementação de cadastro de usuários, instituições e processamento de transações, desenvolvimento colaborativo usando Git e Scrum.
